        ...
        <div className="right col-md-4">
          ...
          <div className="buttons">
            <button type="button" className="left" onClick={handlePrev}>
              <span className={slide.active > 1 ? "d-none" : "d-block"}>
                <svg
                  width="60"
                  height="118"
                  viewBox="0 0 60 118"
              ...
              <span className={slide.active > 1 ? "" : "d-none"}>
                <svg
                  width="60"
                  height="118"
                  viewBox="0 0 60 118"
            ...
            <button type="button" className="right" onClick={handleNext}>
              <span className="button">
                <span
                  className={slide.active < slide.length ? "" : "d-none"}
                >
                  <svg
                    width="60"
                    height="118"
                  ...
                  <span
                    className={
                      slide.active < slide.length ? "d-none" : ""
                    }
                  >
                    <svg
                      width="60"
